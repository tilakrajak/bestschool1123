...
routes.get('/admin/contactdisplay',CheckLogin,ContactController.displaycontact)
routes.post('/insertcontact',ContactController.insertcontact)
...
routes.get('/admin/contactdelete/:id',ContactController.deletecontact)
